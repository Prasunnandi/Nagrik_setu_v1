...
const CITY_CENTERS: Record<string, { lat: number; lng: number; zoom: number }> = {
  ...
  GUWAHATI:           { lat: 26.1445, lng: 91.7898, zoom: 12 },
  ...
  NAGERBAZZAR:        { lat: 22.6247, lng: 88.4194, zoom: 14 },
...
const INDIA_STATES: {
  ...
  {
    id: 'AS', label: 'Assam', emoji: '🦏', cities: ['GUWAHATI'],
    center: { lat: 26.200, lng: 92.937, zoom: 7 }, color: '#0f766e',
    boundary: [[26.85,89.95],[26.90,92.50],[27.95,96.05],[27.05,96.00],[25.20,93.50],[24.25,93.00],[24.30,92.20],[25.10,91.80],[25.90,89.80],[26.85,89.95]],
  },
  {
